...
/// **`CreateBudgetUseCase`** es un caso de uso que encapsula la lógica de negocio
/// para la **creación de un nuevo presupuesto**.
///
...
class CreateBudgetUseCase {
  ...
  /// Constructor de `CreateBudgetUseCase`.
  ///
  ...
  /// Método `execute` que lleva a cabo la operación de crear un presupuesto.
  ///
  /// Recibe un objeto `Budget` que contiene todos los detalles del presupuesto
